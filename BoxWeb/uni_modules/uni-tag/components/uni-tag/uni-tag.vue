...
<style lang="scss" scoped>
	...
	$uni-royal: #9932CD !default;
	$uni-yama: #734A12 !default;
	$uni-tea: #4463b3 !default;
	...
	.uni-tag {
		...
		&--royal {
			color: #fff;
			background-color: $uni-royal;
			border-color: $uni-royal;
		}
		&--yama {
			color: #fff;
			background-color: $uni-yama;
			border-color: $uni-yama;
		}
		&--tea {
			color: #fff;
			background-color: $uni-tea;
			border-color: $uni-tea;
		}
		&--primary--inverted {
			color: $uni-primary;
			border-color: $uni-primary;
